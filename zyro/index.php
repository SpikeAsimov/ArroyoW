<?php
	...
	$pages = array(
		...
		'1'	=> array('id' => '5', 'alias' => 'Trabajo', 'file' => '5.php','controllers' => array()),
		'2'	=> array('id' => '2', 'alias' => 'Sobre-mí', 'file' => '2.php','controllers' => array()),
		'3'	=> array('id' => '3', 'alias' => 'Contactos', 'file' => '3.php','controllers' => array())
	);
	$forms = array(
		'3'	=> array(
			'618dc472' => Array( 'email' => '', 'emailFrom' => '', 'subject' => 'Pregunta desde la página', 'sentMessage' => unserialize('s:30:"El formulario ha sido enviado.";'), 'object' => '', 'objectRenderer' => '', 'loggingHandler' => '', 'smtpEnable' => false, 'smtpHost' => null, 'smtpPort' => null, 'smtpEncryption' => null, 'smtpUsername' => null, 'smtpPassword' => null, 'recSiteKey' => null, 'recSecretKey' => null, 'maxFileSizeTotal' => null, 'fields' => array( array( 'fidx' => '0', 'name' => 'Nombre', 'type' => 'input', 'required' => 1, 'options' => '' ), array( 'fidx' => '1', 'name' => 'E-mail', 'type' => 'input', 'required' => 1, 'options' => '' ), array( 'fidx' => '2', 'name' => 'Mensaje', 'type' => 'textarea', 'required' => 1, 'options' => '' ) ) )
		)
	);
	$langs = null;
	$def_lang = null;
	$base_lang = 'es';
	$site_id = "785ae528";
	$websiteUID = "eee787a594b4ab80ddda309befdad1fd82e25a94eae75fc2c04fd1dcf8356530548b070af5ce58d3";
	$base_dir = dirname(__FILE__);
	$base_url = '/';
	$user_domain = 'arroyowalter.site';
	$home_page = '1';
	$mod_rewrite = true;
	$show_comments = false;
	$comment_callback = "http://uk.zyro.com/es-ES/comment_callback/";
	$user_key = "2+paqUbD3aT481uJxpZ1OGM=";
	$user_hash = "245c603e7e42a82e";
